...
Pure-Rust, `forbid(unsafe)`, read-only **archive-detour** reader and auditor. An
archive is a transparent *outer packing layer*: `evidence.E01.gz` resolves
...
- **`archive-core`** — the peel/detour reader + format detection.
